package com.be_casemodule5.config;

import com.be_casemodule5.config.filter.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers( "/rooms","/rooms/**","/images","/accounts").permitAll()
